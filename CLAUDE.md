...
**Current Version:** v10.67.1 - fix(security): enforce auth on all /api/documents/* routes (GHSA-84hp-mqvj-3p8h, CVSSv3.1 9.8 CRITICAL, commit 907bac72) — ~1,828 tests — see [CHANGELOG.md](CHANGELOG.md) for details
