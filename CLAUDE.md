...
**Current Version:** v10.68.0 - feat(reasoning): temporal edges + fact mutability + RRF fusion (RFC #1008, @filhocf) + fix(security): 32 CodeQL log/path-injection alerts resolved — ~1,828 tests — see [CHANGELOG.md](CHANGELOG.md) for details
